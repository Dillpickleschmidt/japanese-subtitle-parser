...
mod nominarazu_tests {
    ...
    fn test_verb_nominarazu() {
        ...
        assert_has_pattern(&patterns, "のみならず");
        assert_pattern_range(&patterns, "のみならず", 9, 15); // たのみならず
    }
    ...
    fn test_i_adj_nominarazu() {
        ...
        assert_has_pattern(&patterns, "のみならず");
        assert_pattern_range(&patterns, "のみならず", 5, 12); // 暑いのみならず
    }
    ...
    fn test_na_adj_nominarazu() {
        ...
        assert_has_pattern(&patterns, "のみならず");
        assert_pattern_range(&patterns, "のみならず", 9, 15); // なのみならず
    }
    ...
    fn test_noun_nominarazu() {
        ...
        assert_has_pattern(&patterns, "のみならず");
        assert_pattern_range(&patterns, "のみならず", 5, 12); // 子供のみならず
    }
    ...
    fn test_noun_dearu_nominarazu() {
        ...
        assert_has_pattern(&patterns, "のみならず");
        assert_pattern_range(&patterns, "のみならず", 6, 16); // 先生であるのみならず
    }
